...
function fetch_players_with_stats(PDO $pdo, int $edition_id, bool $only_with_stats = false): array {
    $sql = "
        SELECT
            ...
            COALESCE(stats.best_points, 0) AS best_points,
        ...
        LEFT JOIN (
            SELECT
                ...
                COALESCE(MAX(mps.points), 0) AS best_points,
